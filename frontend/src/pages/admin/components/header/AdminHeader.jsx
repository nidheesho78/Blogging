 ...
 if(windowSize.width < 1024) {
  ...
  return (
    <header className="flex h-fit w-full items-center justify-between
     p-4 lg:h-full lg:max-w-[300px] lg:flex-col lg:items-start lg:justify-start lg:p-0">
      {/* logo */}
      <Link to="/">
        <img src={images.logo} alt="logo" className="w-15 lg:hidden"  />
      </Link>
      ...
      {isMenuActive && (
        <div className="fixed inset-0 lg:static lg:h-full lg:w-full">
          ...
          {/*Sidebar */}
          <div className="fixed top-0 bottom-0 left-0 z-50 w-3/4 
          overflow-y-auto bg-white p-4 lg:static lg:h-full lg:w-full lg:p-6">
            <Link to="/">
