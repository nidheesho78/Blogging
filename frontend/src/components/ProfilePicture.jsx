  ...
  return (
    <>
      ...
      <div className="w-full flex items-center gap-x-4">
        <div
          className="relative w-20 h-20 rounded-full outline outline-offset-2 outline-1
       outline-orange-400 overflow-hidden"
        >
          <label
          ...
          >
            {avatar ? (
              ...
              <div className="w-full h-full bg-orange-50/50 flex justify-center items-center">
